...
const STR = {
  en: {
    ...
    lbl_meshtastic_board: 'Board',
    lbl_meshtastic_sync: 'Sync word',
    warn_meshtastic_sync: 'Nodes flashed with 0x12 cannot talk to stock Meshtastic nodes. Every node in the mesh must use this same override. Only needed if your mesh includes LR1121/LR1110/LR1120 hardware.',
    scan_looking: 'Looking for firmware signature',
  ...
  uk: {
    ...
    lbl_meshtastic_board: 'Плата',
    lbl_meshtastic_sync: 'Слово синхронізації',
    warn_meshtastic_sync: 'Пристрої, прошиті з 0x12, не можуть спілкуватися зі стоковими вузлами Meshtastic. Усі вузли мережі мають використовувати те саме перевизначення. Потрібно лише якщо у вашій мережі є обладнання LR1121/LR1110/LR1120.',
    scan_looking: 'Пошук сигнатури прошивки',
