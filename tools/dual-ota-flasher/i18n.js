...
const STR = {
  en: {
    ...
    step1_desc: 'Pick a version + your board, set the region and (optionally) a bind phrase. It downloads the matching pre-built firmware and personalises it <b>in your browser</b> (the bind phrase never leaves this page). No GitHub account or token needed.',
    lbl_version: 'Version', lbl_target: 'Target', lbl_domain: 'Region/domain',
    ...
    lbl_baud: 'Baud', btn_connect: 'Connect',
  ...
  uk: {
    ...
    step1_desc: 'Оберіть версію та свою плату, вкажіть регіон і (за бажанням) фразу прив’язки. Інструмент завантажить відповідну готову прошивку та персоналізує її <b>у вашому браузері</b> (фраза прив’язки не залишає цю сторінку). Не потрібні ні акаунт GitHub, ні токен.',
    lbl_version: 'Версія', lbl_target: 'Плата', lbl_domain: 'Регіон/домен',
    lbl_phrase: 'Фраза прив’язки', ph_phrase: 'необов’язково — лишається локально', lbl_slot: 'Записати у слот',
    ...
    lbl_baud: 'Швидкість', btn_connect: 'Підключити',
